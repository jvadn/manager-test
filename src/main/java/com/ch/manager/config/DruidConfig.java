...
public class DruidConfig {
    ...
    public DataSource druidConfig() {
        ...
        ds.setName(env.getProperty("druid.name", "druid-test"));
    ...
    public ServletRegistrationBean duridServlet() {
        ...
        bean.addInitParameter("loginUsername", env.getProperty("druid.monitor.username", "test"));
        bean.addInitParameter("loginPassword", env.getProperty("druid.monitor.password", "test"));
        return bean;
    }
